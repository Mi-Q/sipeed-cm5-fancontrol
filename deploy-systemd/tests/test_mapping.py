...
class TestExponentialCurve(unittest.TestCase):
    ...
    def test_mid_exponential_lower_than_linear(self):
        ...
        d = temp_to_duty(52.5, min_temp=45.0, max_temp=60.0, min_duty=25.0, curve_type="exponential")
        self.assertAlmostEqual(d, 43.75, places=3)

        # Verify it's lower than linear
        d_linear = temp_to_duty(52.5, min_temp=45.0, max_temp=60.0, min_duty=25.0, curve_type="linear")
    ...
    def test_early_temp_stays_quiet(self):
        ...
        d = temp_to_duty(35.0, min_temp=30.0, max_temp=70.0, min_duty=0.0, curve_type="exponential")
    ...
    def test_high_temp_ramps_fast(self):
        ...
        d = temp_to_duty(65.0, min_temp=30.0, max_temp=70.0, min_duty=0.0, curve_type="exponential")
...
class TestCurveComparison(unittest.TestCase):
    ...
    def test_exponential_quieter_at_low_moderate_temps(self):
        ...
        for temp in [35, 40, 45, 50]:
            d_linear = temp_to_duty(temp, min_temp=30.0, max_temp=70.0, min_duty=0.0, curve_type="linear")
